...
class Game7 : Fragment() {
    private val HarfSayisi=6
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_game7, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        builder.setNegativeButton("Oyundan Çık") { dialog, which ->
            Navigation.findNavController(view).navigate(Game7Directions.actionGame7ToOda7(id.toString(),email.toString()))
        ...
        builder1.setPositiveButton("Kabul Et") { dialog, which ->
            ...
            Navigation.findNavController(view).navigate(Game7Directions.actionGame7Self(id.toString(),email.toString(),Rakip_id.toString()))
        }
