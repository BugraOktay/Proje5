...
class Game1 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        builder.setNegativeButton("Oyundan Çık") { dialog, which ->
            Navigation.findNavController(view).navigate(Game1Directions.actionGame1ToOda1(id.toString(),email.toString()))
        ...
        builder1.setPositiveButton("Kabul Et") { dialog, which ->
            ...
            Navigation.findNavController(view).navigate(Game1Directions.actionGame1ToGame1(id.toString(),email.toString(),Rakip_id.toString()))
        }
