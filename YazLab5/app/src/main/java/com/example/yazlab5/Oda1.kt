...
class Oda1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_oda1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.value!=null){
                    ...
                    builder.setPositiveButton("Evet") { dialog, which ->
                        ...
                        Navigation.findNavController(view).navigate(Oda1Directions.actionOda1ToGame1(id.toString(),email.toString(),Rakip_id))
                    }
        ...
        exit.setOnClickListener(){
            ...
            Navigation.findNavController(it).navigate(Oda1Directions.actionOda1ToFragment2(email.toString(),id.toString()))
        }
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner) {
            val id = arguments?.getString("id")
            val email = arguments?.getString("email")
            database.child("OnlineUsers").child(oda).child(id.toString()).removeValue()
            Navigation.findNavController(view).navigate(Oda1Directions.actionOda1ToFragment2(email.toString(),id.toString()))
        }
