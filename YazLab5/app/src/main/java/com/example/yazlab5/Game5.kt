...
class Game5 : Fragment() {
    private val HarfSayisi=4
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_game5, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        builder.setNegativeButton("Oyundan Çık") { dialog, which ->
            Navigation.findNavController(view).navigate(Game5Directions.actionGame5ToOda5(id.toString(),email.toString()))
        ...
        builder1.setPositiveButton("Kabul Et") { dialog, which ->
            ...
            Navigation.findNavController(view).navigate(Game5Directions.actionGame5Self(id.toString(),email.toString(),Rakip_id.toString()))
        }
