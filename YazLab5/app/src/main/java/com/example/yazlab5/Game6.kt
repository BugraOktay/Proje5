...
class Game6 : Fragment() {
    private val HarfSayisi=5
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_game6, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        builder.setNegativeButton("Oyundan Çık") { dialog, which ->
            Navigation.findNavController(view).navigate(Game6Directions.actionGame6ToOda6(id.toString(),email.toString()))
        ...
        builder1.setPositiveButton("Kabul Et") { dialog, which ->
            ...
            Navigation.findNavController(view).navigate(Game6Directions.actionGame6Self(id.toString(),email.toString(),Rakip_id.toString()))
        }
