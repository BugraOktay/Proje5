...
class Game2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        builder.setNegativeButton("Oyundan Çık") { dialog, which ->
            Navigation.findNavController(view).navigate(Game2Directions.actionGame2ToOda2(id.toString(),email.toString()))
        ...
        builder1.setPositiveButton("Kabul Et") { dialog, which ->
            ...
            Navigation.findNavController(view).navigate(Game2Directions.actionGame2Self(id.toString(),email.toString(),Rakip_id.toString()))
        }
