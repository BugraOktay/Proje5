...
class Oda6 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_oda6, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.value!=null){
                    ...
                    builder.setPositiveButton("Evet") { dialog, which ->
                        ...
                        Navigation.findNavController(view).navigate(Oda6Directions.actionOda6ToGame6(id.toString(),email.toString(),Rakip_id))
                    }
        ...
        exit.setOnClickListener(){
            ...
            Navigation.findNavController(it).navigate(Oda6Directions.actionOda6ToFragment2(email.toString(),id.toString()))
        }
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner) {
            val id = arguments?.getString("id")
            val email = arguments?.getString("email")
            database.child("OnlineUsers").child(oda).child(id.toString()).removeValue()
            Navigation.findNavController(view).navigate(Oda6Directions.actionOda6ToFragment2(email.toString(),id.toString()))
        }
